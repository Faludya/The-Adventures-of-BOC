...
{
	groundLevel = 750;
	gPosition = sf::Vector2f(1850, groundLevel);
...
void LavaGolum::shoot(sf::Time deltaTime)
{
...
void LavaGolum::update(sf::Time deltaTime) {
	if (health <= 0) {
...
* @return bool
*************************************************************************************/
bool LavaGolum::checkCollision(sf::FloatRect spriteShape) {
	bool collision;
...
* @return void
*************************************************************************************/
void LavaGolum::animationUpdate(sf::Time deltaTime) {
...
* @return void
*************************************************************************************/
void LavaGolum::InitAnimations()
{
	//Attack - Throw
	this->pTexture1.loadFromFile("./Resources/Images/Golum3/Golem3RunThrowing.png");
	throwAnimation.setSpriteSheet(pTexture1);
	//Hurt
	this->pTexture2.loadFromFile("./Resources/Images/Golum3/Golem3Hurt.png");
	hurtAnimation.setSpriteSheet(pTexture2);
	//Dying
	this->pTexture3.loadFromFile("./Resources/Images/Golum3/Golem3Dying.png");
...
* @return void
*************************************************************************************/
void LavaGolum::draw(sf::RenderWindow& window)
{
...
sf::FloatRect LavaGolum::getEnemyGlobalBounds()
{
	return animatedSprite.getGlobalBounds();
}

void LavaGolum::updateHealth(int addedHealth)
{
	this->health += addedHealth;
}

int LavaGolum::getEnemyHealth()
{
	return health;
}
